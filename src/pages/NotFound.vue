  ...
  >
    <div class="grid justify-content-center p-2 lg:p-0" style="min-width: 80%">
      <div class="col-12 mt-5 xl:mt-0 text-center">
        <img
          src="layout/images/logo-blue.svg"
          alt="Sakai logo"
          class="mb-5"
        ...
        >
          <div class="grid flex-column align-items-center">
            ...
            >
              ...
              >
                <i class="pi pi-fw pi-table text-50 text-2xl" />
              </div>
              <div class="ml-4">
                <router-link to="/">
                ...
                <span class="text-gray-600 lg:text-xl"
            ...
            >
              <div
                ...
                style="height: 3.5rem; width: 3.5rem"
              >
                <i class="pi pi-fw pi-question-circle text-50 text-2xl" />
              </div>
              <div class="ml-4">
                <router-link to="/">
                  <p class="text-900 lg:text-xl font-medium mb-0">
            ...
            >
              <div
                ...
                style="height: 3.5rem; width: 3.5rem"
              >
                <i class="pi pi-fw pi-unlock text-50 text-2xl" />
              </div>
              <div class="ml-4">
                <router-link to="/">
                  <p class="text-900 lg:text-xl font-medium mb-0">

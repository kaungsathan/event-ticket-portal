    ...
    <form class="p-fluid" @submit.prevent="handleSubmit(!v$.$invalid)">
      <div class="grid">
        ...
        <div class="field col-12 md:col-6 lg:col-4">
          ...
          <small v-if="(v$.age.$invalid && submitted) || v$.age.$pending.$response" class="p-error">{{
            v$.age.required.$message.replace("Value", "Age")
          }}</small>
        </div>
        <div class="field col-12 md:col-6 lg:col-4">
        ...
        <div class="field col-12 md:col-6 lg:col-4">
          ...
          <small v-if="(v$.gender.$invalid && submitted) || v$.gender.$pending.$response" class="p-error">{{
